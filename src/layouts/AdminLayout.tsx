...
const navItems = [
  ...
  { label: 'Agents', path: '/admin/agents', icon: <SupportAgentIcon /> },
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <Box sx={{ p: 2, display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Box sx={{ flex: 1, overflow: 'hidden' }}>
              ...
              <Typography sx={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem' }}>Admin</Typography>
            </Box>
      ...
      >
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ fontSize: '0.72rem', color: '#4ade80', fontWeight: 600 }}>System online</Typography>
          </Box>
        </Box>
